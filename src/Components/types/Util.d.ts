...
/**
 * @see https://github.com/jgraph/mxgraph/blob/master/javascript/src/js/util/mxMouseEvent.js
 */
declare class mxMouseEvent {
  ...
  getState() : mxCellState | null;

  /**
   * @see https://github.com/jgraph/mxgraph/blob/master/javascript/src/js/util/mxMouseEvent.js#L181
   */
  getCell() : mxCell | null;
