...
// // @JsonConverter
// // export class SimpleFilterOperatorConverter
// //   implements JsonCustomConvert<SimpleFilterOperator> {
...
// //     if ("uri" in data) {
// //       return Json2TypescriptService.converter().deserializeObject(
// //         data,
// //         OntologyRelation
// //       );
// //     } else {
...
//   @JsonProperty("filter", FilterGroup, true)
//   filter: FilterGroup = new FilterGroup();

//   @JsonProperty("constant", String, true)
//   constant: string = null;

//   constructor(filter: FilterGroup, constant: string) {
//     debugger;
//     this.filter = filter;
